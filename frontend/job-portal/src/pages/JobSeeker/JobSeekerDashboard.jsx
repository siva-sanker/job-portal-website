...
const JobSeekerDashboard = () => {
  ...
  const MobileFilterOverlay=()=>(
    <div className={`fixed inset-0 z-50 hidden ${ showMobileFilters ? "" : "hidden"}`}>
      ...
      >
        <div className="fixed inset-y-0 right-0 w-full max-w-sm bg-white shadow-xl">
          <div className="flex items-center justify-between p-6 border-b border-gray-200">
            ...
            <button className="p-2 hover:bg-gray-100 rounded-xl transitio-colors"
              onClick={()=>setShowMobileFilters(false)}
            >
              <X className='w-5 h-5' />
            </button>
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex flex-col lg:flex-row lg:items-center justify-between mb-6 lg:mb-8 gap-4">
                ...
                <div className="flex items-center justify-between lg:justify-end gap-4">
                  ...
                  <button className="lg:hidden flex items-center gap-2 bg-white px-4 py-2 rounded-xl border border-gray-200 font-medium text-gray-700 hover:bg-gray-50 transition-colors"
