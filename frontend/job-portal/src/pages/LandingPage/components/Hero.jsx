...
const Hero = () => {
  ...
  const stats=[
      ...
      {icon:TrendingUp,label:"jobs posted",value:'150+'},
  ];
  return (
    <section className='pt-24 pb-16 bg-white min-h-screen flex items-center'>
      <div className='container mx-auto px-4'>
        <div className="max-w-4xl mx-auto text-center">
          ...
          className='text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight pt-10 capitalize'
          >
          ...
          >
            ...
            whileTap={{scale:1.02}}
            className='group bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-xl font-semibold text-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-300 shadow-xl flex items-center space-x-2'
          ...
          >
            {stats.map((stat,index) =>(
              ...
              >
                ...
                <div className='text-sm text-gray-600 font-medium capitalize'>{stat.label}</div>
              </motion.div>
            ))}
          </motion.div>
        </div>
