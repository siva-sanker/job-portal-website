...
const JobPostingForm = () => {
  ...
  const validateForm=(formData)=>{
    ...
    if(!formData.jobType){
      errors.category="Please select a job type"
    }
  ...
  return (
    <DashboardLayout activeMenu='post-job'>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-purple-50/20 pu-8 px-4 sm:px-6 lg:px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <TextareaField
              ...
              id="description"
              placeholder="Describe the role and responsibilites..."
              value={formData.description}
              onChange={(e)=>handleInputChange("description",e.target.value)}
              error={errors.description}
              helperText="Inlcude key responsibilities, day-to-day tasks, and what makes this role exciting"
              required
            />
            ...
            <TextareaField
              ...
              helperText="Include required skills, experience level, education, and any preferred quailfications"
              required
            />
