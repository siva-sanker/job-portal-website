      ...
      <div className={`fixed inset-y-0 left-0 z-50 transition-transform duration-300 transform ${
        ...
        ${sidebarCollapsed ?"w-16":"w-64"} bg-white border-r border-gray-200`}>
          ...
          <div className="flex items-center h-16 border-b border-gray-200 pl-6">
            {!sidebarCollapsed?(
              <Link className='flex items-center space-x-3' to='/'>
                <div className="h-8 w-8 bg-gradient-to-br from-blue-600 to-blue-700 rounded-lg items-center flex justify-center">
          ...
          <div className="absolute bottom-4 left-4 right-4">
            <button
            className='w-full flex items-center px-3 py-2.5 text-sm fomt-medium rounded-lg text-gray-600 hover:bg-gray-50 hover:text-gray-900 transition-all duration-200'
            onClick={logout}
          >
