        ...
        <div className="p-6">
          <div className="text-center mb-6">
            {selectedApplicant.applicant.avatar ? (
              <img src={selectedApplicant.applicant.avatar} alt={selectedApplicant.applicant.name}
            ...
            <h4 className="mt-4 text-xl font-semibold text-gray-900 capitalize">
          ...
          <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-gray-900">
                    {moment(selectedApplicant.job.createdAt)?.format("DD MM YYYY")}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="mt-4">
              ...
              <select
                ...
                disabled={loading}
                className='w-full border border-gray-300 rounded-lg p-2 focus:ring-blue-500 focus:border-blue-500 capitalize'
              >
                {statusOptions.map((status)=>(
                  <option value={status} key={status} className='capitalize'>{status}</option>
                ))}
              </select>
              {loading && ( 
