...
import { MapPin,DollarSign,ArrowLeft,Building2,Clock,Users, User } from 'lucide-react';
              ...
              <div className="relative z-10">
                ...
                {user?.companyLogo ?(
                  <img src={user.companyLogo} alt="Company Logo"
                    className='h-16 md:h-20 w-16 md:w-20 object-cover rounded-2xl border-4 bordder-white/20 shadow-lg'
                  />
                ):(
